...
from bbp.tag_script.lexer.error.tag_expression_value_error import TagExpressionValueError
from bbp.tag_script.lexer.error.lexical_error import LexicalError
...
class TestLexer(unittest.TestCase):
    ...
    def test_tag_script_lexer_lexer_members_initialized_as_expected(self, test_context):
    ...
    def test_tag_script_lexer_lexer_calling_tokenize_with_whitespace_characters_should_return_empty_tokens(self, test_context):
        expected_tokens = []
        expression = "    	  	"
    ...
    def test_tag_script_lexer_lexer_calling_tokenize_should_return_expected_tokens_tokens(self, test_context):
    ...
    def test_tag_script_lexer_lexer_calling_tokenize_with_valid_expression_should_return_a_list_of_matching_tokens(self, test_context):
    ...
    def test_tag_script_lexer_lexer_calling_tokenize_with_invalid_expression_should_raise_an_error(self, test_context):
        lexer = Lexer(test_context.logger, self._mock_tag_expression_builder)
